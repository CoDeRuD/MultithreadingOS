/***************************************************************************************************************
     PART 4: assign4-part4.c written by Lavell Townsel

Purpose:
     utilize pthread_mutex_trylock to solve the deadlock problem.

     use multiple mutex objects to represent the chopsticks. 

Command Parameters:
     gcc -pthread -o assign4p4 assign4-part4.c
     ./assign4p4 <nthreads>
...
Notes:
     - instead of pthread_mutex_lock, use pthread_mutex_trylock
     - any number of conditional variables can be used if necessary to obtain proper synchonization 
